...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="sv" lang="sv">
	<head>
		...
		<meta name="description" content="BOM-list for project <?php
							...
							$project_id = mysqli_real_escape_string($con, $_GET["proj_id"]);
							$owner = $_SESSION['SESS_MEMBER_ID'];
							
							$result = mysqli_Query($con, "SELECT project_name FROM projects WHERE project_owner = ".$owner." AND project_id = ".$project_id."");
