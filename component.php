		...
		<div class="componetInfo">
			<table class="globalTables leftAlign noHover" cellpadding="0" cellspacing="0">
				<tbody>
					...
					<tr>
						<td class="boldText">Chemical Formula</td>
						<td>
							<?php
					...
					<tr>
						...
						<td class="boldText">MSDS PDF</td>
						<td>
							<?php
							$cas_number = $executesql['cas_number'];
							if ($cas_number != "") {
								if (file_exists("pdf/" . $cas_number . ".pdf")){
								?>
								<a target="_blank" href="<?php echo "/pdf/" . $cas_number . ".pdf" ?>">
									<img height="30" src="\img\pdf.png" />
								</a>
							<?php
								} else {
									echo "-";
